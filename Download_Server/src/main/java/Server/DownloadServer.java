...
//        ticket_v.getDate("Lifetime4");
    ...
    public boolean Delete_Handler(String message) throws Exception {
        ...
        for (String f : filename) {
            File file = new File("C:\\Users\\20125\\Desktop\\GuaWazi-Network-Disk-master\\keep\\" + this.Client_ID + File.separator + f);
            if (file.delete() == false) {
                logger.error("系统错误");
                return false;
            }
            logger.error("C:\\Users\\20125\\Desktop\\GuaWazi-Network-Disk-master\\keep\\" + this.Client_ID + File.separator + f + "删除成功");
        }
        return true;
    }
